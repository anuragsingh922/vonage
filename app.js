...
// const pcmUtils = require('node-pcm-utils');
...
//     // const mainText = response.data.choices[0].message.content;
...
//               }
//               chatt += content;
//               // chathistory = chathistory + `user : ${text} \nassistent : ${chatt}`;
//             }
//           }
//     });
...
//       // await call_elevenlab_api(chatt);
//     });
...
// const call_elevenlab_api = async (textt) => {
//   try {
//     console.log("t-t-s");
//     // Set the API key for ElevenLabs API.
//     // Do not use directly. Use environment variables.

//     const inputText = textt;
//     // const API_KEY = "3e094584b0eba78bf35c007c5e20c9f2";
//     const API_KEY = "a7dafbae5b50b0efc566cec5440789bd";
...
//     const options = {
//       method: "POST",
//       url: `https://api.elevenlabs.io/v1/text-to-speech/${VOICE_ID}/stream?optimize_streaming_latency=3`,
//       headers: {
...
//       },
//       // responseType: 'stream', // Set the responseType to arraybuffer to receive binary data as response.
...
//     const fileName = 'generated-audio.mp3';
...
app.ws("/socket", async (ws, res) => {
  ...
  try {
      ...
      try {
        if (isBuffer(msg)) {
          ...
          if (detectSilence(newarrbuffer, SILENCE_THRESHOLD)) {
            // console.log('Silence detected in audio buffer.' + ++times);
            // Do something when silence is detected in the audio buffer
              ...
              file.end(async () => {
                ...
                try {
                  ...
                  if (speech_text !== "" && speech_text !== undefined && !canrun) {
                    ...
                    // await call_elevenlab_api(ai_response_text);
                  }
                  else {
    ...
    ws.on('close', async () => {
      ...
      //     const ai_response_text = await ai_responsee(speech_text);
      //     console.log("Speech to text : " + ai_response_text);
