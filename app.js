...
const ai_responsee = async (text, chathistory) => {
...
const call_elevenlab_api = async (text) => {
  try {

    const apiKey = "89d831bbca61e44d0abd355854fe7030"; // Your API key from Elevenlabs
    ...
    console.log("Error in elevenlab api  :  " + err.message);
  }
}
              ...
              file.end(async () => {
                ...
                try {
                  ...
                  if (speech_text!=="" && speech_text!==undefined && !canrun) {
                    ...
                    const ai_response_text = await ai_responsee(speech_text, chathistory);
                    console.log("Speech to text : " + ai_response_text);

                    chathistory = chathistory + `user : ${speech_text} \nassistent : ${ai_response_text}`;
